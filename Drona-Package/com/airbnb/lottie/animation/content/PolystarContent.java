  ...
  implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent
{
  ...
  private void createPolygonPath()
  {
    ...
    while (i < d4)
    {
      f3 = (float)(Math.cos(d1) * d2);
      float f4 = (float)(d2 * Math.sin(d1));
      if (f5 != 0.0F)
      {
  ...
  private void createStarPath()
  {
    ...
    float f3 = ((Float)outerRadiusAnimation.getValue()).floatValue();
    float f4 = ((Float)innerRadiusAnimation.getValue()).floatValue();
    float f2;
    if (innerRoundednessAnimation != null) {
      f2 = ((Float)innerRoundednessAnimation.getValue()).floatValue() / 100.0F;
    } else {
      f2 = 0.0F;
    }
    if (outerRoundednessAnimation != null) {
      f1 = ((Float)outerRoundednessAnimation.getValue()).floatValue() / 100.0F;
    } else {
      f1 = 0.0F;
    }
    float f5;
    ...
    for (;;)
    {
      ...
      double d4 = f10;
      float f14 = (float)(d4 * Math.cos(d1));
      float f15 = (float)(d4 * Math.sin(d1));
      if ((f2 == 0.0F) && (f1 == 0.0F)) {
        path.lineTo(f14, f15);
      }
      for (;;)
      {
        ...
        d4 = (float)(Math.atan2(f15, f14) - 1.5707963267948966D);
        ...
        path.cubicTo(f8 - f10, f7 - f12, f14 + f11, f15 + f6, f14, f15);
      }
      d1 += f9;
      j ^= 0x1;
      i += 1;
  ...
  public void addValueCallback(Object paramObject, LottieValueCallback paramLottieValueCallback)
  {
    ...
    if ((paramObject == LottieProperty.POLYSTAR_INNER_RADIUS) && (innerRadiusAnimation != null))
    {
    ...
    if ((paramObject == LottieProperty.POLYSTAR_INNER_ROUNDEDNESS) && (innerRoundednessAnimation != null))
    {
