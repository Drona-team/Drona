  ...
  implements BaseKeyframeAnimation.AnimationListener, KeyPathElementContent, PathContent
{
  ...
  public Path getPath()
  {
    ...
    PointF localPointF = (PointF)sizeAnimation.getValue();
    float f4 = x / 2.0F;
    float f5 = y / 2.0F;
    float f1;
    if (cornerRadiusAnimation == null) {
      ...
      f1 = ((FloatKeyframeAnimation)cornerRadiusAnimation).getFloatValue();
    }
    ...
    localPointF = (PointF)positionAnimation.getValue();
