...
{
  private static final String NOT = "LottieAnimationView";
  ...
  public void setAnimation(JsonReader paramJsonReader, String paramString)
  {
  ...
  {
    setAnimation(JsonReader.socket(Okio.buffer(Okio.source(new ByteArrayInputStream(paramString1.getBytes())))), paramString2);
  }
