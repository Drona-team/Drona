...
{
  public static final String PAGE_KEY = "com.amplitude.api.PinnedAmplitudeClient";
  ...
  static Map<String, com.amplitude.api.PinnedAmplitudeClient> instances = new HashMap();
  ...
  protected SSLSocketFactory getPinnedCertSslSocketFactory(SSLContextBuilder paramSSLContextBuilder)
  {
    ...
    if (sslSocketFactory == null) {
      try
      {
        paramSSLContextBuilder = paramSSLContextBuilder.build().getSocketFactory();
        sslSocketFactory = paramSSLContextBuilder;
        paramSSLContextBuilder = logger;
        paramSSLContextBuilder.i("com.amplitude.api.PinnedAmplitudeClient", "Pinning SSL session using Comodo CA Cert");
      }
  ...
  public AmplitudeClient initialize(Context paramContext, String paramString1, String paramString2)
  {
    try
    {
      ...
      runOnLogThread(new PinnedAmplitudeClient.1(this, this));
      return this;
    }
  ...
  public class SSLContextBuilder
  {
    ...
    public SSLContext build()
    {
      try
      {
        ...
        Object localObject2 = certificateBase64s;
        ...
        for (;;)
        {
          ...
          localObject3 = ((CertificateFactory)localObject1).generateCertificate(new Buffer().write(ByteString.decodeBase64((String)localObject3)).inputStream());
          localObject3 = (X509Certificate)localObject3;
          localKeyStore.setCertificateEntry(Integer.toString(i), (Certificate)localObject3);
          i += 1;
        }
