...
{
  public static final String PAGE_KEY = "com.amplitude.api.Identify";
  ...
  private void addToUserProperties(String paramString1, String paramString2, Object paramObject)
  {
    ...
    JSONObject localJSONObject = userPropertiesOperations;
    try
    {
      boolean bool = localJSONObject.has(paramString1);
      if (!bool)
      {
        localJSONObject = userPropertiesOperations;
        localJSONObject.put(paramString1, new JSONObject());
      }
      localJSONObject = userPropertiesOperations;
      localJSONObject.getJSONObject(paramString1).put(paramString2, paramObject);
      paramString1 = userProperties;
  ...
  public Identify addPlaylist(String paramString, int paramInt)
  {
    addToUserProperties("$set", paramString, Integer.valueOf(paramInt));
    return this;
  }
  
  public Identify addPlaylist(String paramString, long paramLong)
  {
    addToUserProperties("$set", paramString, Long.valueOf(paramLong));
    return this;
  }
  
  public Identify addUrls(String paramString1, String paramString2)
  {
  ...
  public Identify chunk(String paramString, JSONObject paramJSONObject)
  {
  ...
  public Identify configure(String paramString, Object paramObject)
  {
  ...
  public Identify confirm(String paramString, JSONArray paramJSONArray)
  {
    addToUserProperties("$set", paramString, paramJSONArray);
    return this;
  }
  
  public Identify createModel(String paramString, JSONObject paramJSONObject)
  {
    addToUserProperties("$set", paramString, paramJSONObject);
    return this;
  }
  
  public Identify distinct(String paramString, boolean[] paramArrayOfBoolean)
  {
    addToUserProperties("$set", paramString, booleanArrayToJSONArray(paramArrayOfBoolean));
    return this;
  }
  
  public Identify getOutputMediaFile(String paramString, float paramFloat)
  {
  ...
  public JSONObject getUserPropertiesOperations()
  {
    ...
    try
    {
      localJSONObject = new JSONObject(localJSONObject.toString());
  ...
  public Identify removePlaylist(String paramString, double[] paramArrayOfDouble)
  {
    addToUserProperties("$set", paramString, doubleArrayToJSONArray(paramArrayOfDouble));
    return this;
  }
  
  public Identify removePlaylist(String paramString, int[] paramArrayOfInt)
  {
    addToUserProperties("$set", paramString, intArrayToJSONArray(paramArrayOfInt));
    return this;
  }
  
  public Identify removePlaylist(String paramString, long[] paramArrayOfLong)
  {
    addToUserProperties("$set", paramString, longArrayToJSONArray(paramArrayOfLong));
    return this;
  }
  
  public Identify removePlaylist(String paramString, String[] paramArrayOfString)
  {
    addToUserProperties("$set", paramString, stringArrayToJSONArray(paramArrayOfString));
    return this;
  }
  
  public Identify respondWith(String paramString1, String paramString2)
  {
  ...
  public Identify setFloatValue(String paramString, float paramFloat)
  {
    addToUserProperties("$set", paramString, Float.valueOf(paramFloat));
    return this;
  }
  
  public Identify setFloatValue(String paramString, float[] paramArrayOfFloat)
  {
  ...
  public Identify setSongs(String paramString, int paramInt)
  {
