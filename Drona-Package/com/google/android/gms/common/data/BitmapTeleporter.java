  ...
  implements ReflectedParcelable
{
  ...
  {
    zalf = paramInt1;
    zalg = paramParcelFileDescriptor;
    mType = paramInt2;
    zalh = null;
    zali = false;
  }
  ...
  private final java.io.FileOutputStream zabz()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 79	com/google/android/gms/common/data/BitmapTeleporter:zalj	Ljava/io/File;
    //   4: ifnull +67 -> 71
    //   7: aload_0
    //   8: getfield 79	com/google/android/gms/common/data/BitmapTeleporter:zalj	Ljava/io/File;
    //   11: astore_1
    //   12: ldc 81
    //   14: ldc 83
    //   16: aload_1
    ...
    //   37: aload_0
    //   38: aload_3
    //   39: putfield 47	com/google/android/gms/common/data/BitmapTeleporter:zalg	Landroid/os/ParcelFileDescriptor;
    //   42: aload_1
  ...
  public Bitmap get()
  {
    if (!zali)
    {
      Object localObject1 = new DataInputStream(new ParcelFileDescriptor.AutoCloseInputStream(zalg));
      try
      {
  ...
  public void release()
  {
    if (!zali)
    {
      ParcelFileDescriptor localParcelFileDescriptor = zalg;
      try
      {
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    SafeParcelWriter.writeParcelable(paramParcel, 2, zalg, paramInt | 0x1, false);
