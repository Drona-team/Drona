  ...
  extends StatsEvent
{
  ...
  public WakeLockEvent(long paramLong1, int paramInt1, String paramString1, int paramInt2, List paramList, String paramString2, long paramLong2, int paramInt3, String paramString3, String paramString4, float paramFloat, long paramLong3, String paramString5, boolean paramBoolean)
  {
  ...
  public final String getRawText()
  {
    ...
    boolean bool = zzgb;
    StringBuilder localStringBuilder = new StringBuilder(String.valueOf(str5).length() + 51 + String.valueOf(str1).length() + String.valueOf(str2).length() + String.valueOf(str3).length() + String.valueOf(str4).length());
  ...
  public final void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    SafeParcelWriter.writeLong(paramParcel, 16, zzga);
    SafeParcelWriter.writeString(paramParcel, 17, zzfs, false);
    SafeParcelWriter.writeBoolean(paramParcel, 18, zzgb);
