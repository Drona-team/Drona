...
import com.google.android.gms.common.package_6.internal.BaseImplementation.ApiMethodImpl;
import com.google.android.gms.common.package_6.internal.Elements;
import com.google.android.gms.common.package_6.internal.LifecycleActivity;
import com.google.android.gms.common.package_6.internal.ListenerHolder;
import com.google.android.gms.common.package_6.internal.Logger;
import com.google.android.gms.common.package_6.internal.SignInConnectionListener;
import com.google.android.gms.common.package_6.internal.zaaw;
import com.google.android.gms.common.package_6.internal.zacm;
...
public abstract class GoogleApiClient
{
  ...
  public final class Builder
  {
    ...
    private final Map<Api<?>, com.google.android.gms.common.api.Api.ApiOptions> zabz = new ArrayMap();
    ...
    private com.google.android.gms.common.api.Api.AbstractClientBuilder<? extends zad, SignInOptions> zace = zaa.zaph;
    private final ArrayList<com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks> zacf = new ArrayList();
    private final ArrayList<com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener> zacg = new ArrayList();
    ...
    public final Builder addApi(Sample paramSample, Api.ApiOptions.HasOptions paramHasOptions)
    {
      ...
      zabz.put(paramSample, paramHasOptions);
    ...
    {
      Preconditions.checkArgument(zabz.isEmpty() ^ true, "must call addApi() to add at least one API");
      ...
      Iterator localIterator = zabz.keySet().iterator();
      int j = 0;
      boolean bool;
      while (localIterator.hasNext())
      {
        localObject2 = (Sample)localIterator.next();
        Object localObject4 = zabz.get(localObject2);
      ...
      Object localObject2 = new zaaw(GoogleApiClient.this, new ReentrantLock(), zabj, (ClientSettings)localObject3, zacd, zace, localArrayMap1, zacf, zacg, localArrayMap2, zacb, i, localArrayList, false);
      ...
      try
      {
        ...
        if (zacb >= 0)
        {
          Elements.select(zaca).get(zacb, (GoogleApiClient)localObject2, zacc);
          return localObject2;
        }
      }
      catch (Throwable localThrowable)
    ...
    public final ClientSettings buildClientSettings()
    {
      ...
      if (zabz.containsKey(zaa.API)) {
        localSignInOptions = (SignInOptions)zabz.get(zaa.API);
      }
      return new ClientSettings(textAlignment, zabr, zabx, zabt, zabu, zabv, zabw, localSignInOptions, false);
    }
    ...
    public final Builder enableAutoManage(FragmentActivity paramFragmentActivity, int paramInt, GoogleApiClient.OnConnectionFailedListener paramOnConnectionFailedListener)
    {
      ...
      zacb = paramInt;
      zacc = paramOnConnectionFailedListener;
      zaca = paramFragmentActivity;
      return this;
    }
