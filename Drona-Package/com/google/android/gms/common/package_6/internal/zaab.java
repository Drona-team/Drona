...
{
  private final Map<com.google.android.gms.common.api.internal.BasePendingResult<?>, Boolean> zafk = Collections.synchronizedMap(new WeakHashMap());
  private final Map<TaskCompletionSource<?>, Boolean> zafl = Collections.synchronizedMap(new WeakHashMap());
  
  public zaab() {}
  
  /* Error */
  private final void forEach(boolean paramBoolean, com.google.android.gms.common.package_6.Status paramStatus)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 24	com/google/android/gms/common/package_6/internal/zaab:zafk	Ljava/util/Map;
    //   4: astore_3
    //   5: aload_3
    //   6: monitorenter
    ...
    //   10: dup
    //   11: aload_0
    //   12: getfield 24	com/google/android/gms/common/package_6/internal/zaab:zafk	Ljava/util/Map;
    //   15: invokespecial 38	java/util/HashMap:<init>	(Ljava/util/Map;)V
    //   18: astore 4
    //   20: aload_3
    //   21: monitorexit
    //   22: aload_0
    //   23: getfield 26	com/google/android/gms/common/package_6/internal/zaab:zafl	Ljava/util/Map;
    //   26: astore 5
    //   28: aload 5
    //   30: monitorenter
    ...
    //   34: dup
    //   35: aload_0
    //   36: getfield 26	com/google/android/gms/common/package_6/internal/zaab:zafl	Ljava/util/Map;
    ...
    //   109: checkcast 75	com/google/android/gms/common/package_6/internal/BasePendingResult
    //   112: aload_2
    //   113: invokevirtual 79	com/google/android/gms/common/package_6/internal/BasePendingResult:await	(Lcom/google/android/gms/common/package_6/Status;)V
    //   116: goto -56 -> 60
    //   119: aload_3
    ...
    //   178: checkcast 81	com/google/android/gms/tasks/TaskCompletionSource
    //   181: new 83	com/google/android/gms/common/package_6/ApiException
    //   184: dup
    //   185: aload_2
    //   186: invokespecial 85	com/google/android/gms/common/package_6/ApiException:<init>	(Lcom/google/android/gms/common/package_6/Status;)V
    //   189: invokevirtual 89	com/google/android/gms/tasks/TaskCompletionSource:trySetException	(Ljava/lang/Exception;)Z
    //   192: pop
    //   193: goto -62 -> 131
    //   196: return
    //   197: astore_2
    ...
    //   0	208	2	paramStatus	com.google.android.gms.common.package_6.Status
  ...
  {
    zafk.put(paramBasePendingResult, Boolean.valueOf(paramBoolean));
  ...
  {
    zafl.put(paramTaskCompletionSource, Boolean.valueOf(paramBoolean));
    paramTaskCompletionSource.getTask().addOnCompleteListener(new zaad(this, paramTaskCompletionSource));
  }
  
  final boolean zaag()
  {
    return (!zafk.isEmpty()) || (!zafl.isEmpty());
  }
  
  public final void zaah()
  {
    forEach(false, GoogleApiManager.zahx);
  }
  
  public final void zaai()
  {
    forEach(true, zacp.zakx);
  }
}
