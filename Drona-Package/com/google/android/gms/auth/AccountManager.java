...
public class AccountManager
{
    ...
    throws IOException, GoogleAuthException
  {
    ...
    paramContext = GmsClientSupervisor.getInstance(paramContext);
    if (paramContext.bindService(paramComponentName, localBlockingServiceConnection, "GoogleAuthUtil"))
    {
      try
      {
        paramObject = paramObject.doInBackground(localBlockingServiceConnection.getService());
        paramContext.unbindService(paramComponentName, localBlockingServiceConnection, "GoogleAuthUtil");
        return paramObject;
      }
      catch (Throwable paramObject) {}catch (RemoteException|InterruptedException paramObject)
      {
        LOG.i("GoogleAuthUtil", new java.lang.Object[] { "Error on service connection.", paramObject });
        throw new IOException("Error on service connection.", paramObject);
      }
      paramContext.unbindService(paramComponentName, localBlockingServiceConnection, "GoogleAuthUtil");
      throw paramObject;
    }
    ...
    throws GoogleAuthException, IOException
  {
    ...
    create(paramAccount);
    ensurePlayServicesAvailable(paramContext, 8400000);
    paramAccount = new SyncManager.7(paramAccount);
