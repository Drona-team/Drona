...
import com.google.android.gms.auth.util.signin.internal.Addon;
...
public final class GoogleSignIn
{
  ...
  {
    return Addon.get(paramContext).getRating();
  }
  
  public static Task getSignedInAccountFromIntent(Intent paramIntent)
  {
    paramIntent = Bus.getSignInResultFromIntent(paramIntent);
    if (paramIntent == null) {
