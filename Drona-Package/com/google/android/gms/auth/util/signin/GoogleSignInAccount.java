...
{
  public static final Parcelable.Creator<com.google.android.gms.auth.api.signin.GoogleSignInAccount> CREATOR = new DiscreteSeekBar.CustomState.1();
  @VisibleForTesting
  ...
  private final JSONObject doInBackground()
  {
    ...
    try
    {
      ...
      localObject3 = new com.google.android.gms.common.package_6.Scope[i];
      ...
      while (i < j)
      {
        ...
        ((JSONArray)localObject1).put(((com.google.android.gms.common.package_6.Scope)localObject3).getScopeUri());
        i += 1;
      }
    ...
    throws JSONException
  {
    ...
    while (i < j)
    {
      localHashSet.add(new com.google.android.gms.common.package_6.Scope(localJSONArray.getString(i)));
      i += 1;
    }
  ...
  public GoogleSignInAccount requestExtraScopes(com.google.android.gms.common.package_6.Scope... paramVarArgs)
  {
