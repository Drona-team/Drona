...
{
  @VisibleForTesting
  public static final com.google.android.gms.common.package_6.Scope CACHE = new com.google.android.gms.common.package_6.Scope("profile");
  ...
  @VisibleForTesting
  public static final com.google.android.gms.common.package_6.Scope EMAIL;
  @VisibleForTesting
  public static final com.google.android.gms.common.package_6.Scope EXCLUSIVE;
  @VisibleForTesting
  public static final com.google.android.gms.common.package_6.Scope LASTFM = new com.google.android.gms.common.package_6.Scope("email");
  @VisibleForTesting
  public static final com.google.android.gms.common.package_6.Scope LOCAL = new com.google.android.gms.common.package_6.Scope("openid");
  ...
  static
  {
    EXCLUSIVE = new com.google.android.gms.common.package_6.Scope("https://www.googleapis.com/auth/games_lite");
    EMAIL = new com.google.android.gms.common.package_6.Scope("https://www.googleapis.com/auth/games");
    DEFAULT_SIGN_IN = new Builder().requestId().requestProfile().build();
    DEFAULT_GAMES_SIGN_IN = new Builder().requestScopes(EXCLUSIVE, new com.google.android.gms.common.package_6.Scope[0]).build();
  }
  ...
  private final JSONObject put()
  {
    ...
    try
    {
      ...
      while (i < j)
      {
        ...
        i += 1;
        localObject2 = (com.google.android.gms.common.package_6.Scope)localObject2;
        ((JSONArray)localObject1).put(((com.google.android.gms.common.package_6.Scope)localObject2).getScopeUri());
      }
    ...
    throws JSONException
  {
    ...
    while (i < j)
    {
      localHashSet.add(new com.google.android.gms.common.package_6.Scope(paramString.getString(i)));
      i += 1;
    }
  ...
  public com.google.android.gms.common.package_6.Scope[] getScopeArray()
  {
    return (com.google.android.gms.common.package_6.Scope[])data.toArray(new com.google.android.gms.common.package_6.Scope[data.size()]);
  }
  ...
  public int hashCode()
  {
    ...
    while (i < j)
    {
      ...
      i += 1;
      localArrayList1.add(((com.google.android.gms.common.package_6.Scope)localObject).getScopeUri());
    }
  ...
  public final class Builder
  {
    ...
    public final Builder addExtension(GoogleSignInOptionsExtension paramGoogleSignInOptionsExtension)
    {
      if (!zaag.containsKey(Integer.valueOf(paramGoogleSignInOptionsExtension.getExtensionType())))
      {
        ...
        zaag.put(Integer.valueOf(paramGoogleSignInOptionsExtension.getExtensionType()), new com.google.android.gms.auth.util.signin.internal.GoogleSignInOptionsExtensionParcelable(paramGoogleSignInOptionsExtension));
        return this;
      }
    ...
    public final Builder requestScopes(com.google.android.gms.common.package_6.Scope paramScope, com.google.android.gms.common.package_6.Scope... paramVarArgs)
    {
