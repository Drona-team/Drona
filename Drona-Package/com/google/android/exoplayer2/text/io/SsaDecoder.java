package com.google.android.exoplayer2.text.io;
  ...
  extends SimpleSubtitleDecoder
{
  ...
  private static final String PAGE_KEY = "SsaDecoder";
  ...
  public SsaDecoder(List paramList)
  {
    super("SsaDecoder");
  ...
  private void parseDialogueLine(String paramString, List paramList, LongArray paramLongArray)
  {
    if (formatKeyCount == 0)
    {
  ...
  private void parseEventBody(ParsableByteArray paramParsableByteArray, List paramList, LongArray paramLongArray)
  {
    for (;;)
    {
