...
final class CachedContent
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      return (length == length) && (key.equals(key)) && (cachedSpans.equals(cachedSpans)) && (metadata.equals(metadata));
    }
    return false;
  }
  ...
  public long getCachedBytesLength(long paramLong1, long paramLong2)
  {
    ...
    if (((CacheSpan)localObject).isHoleSpan())
    {
      if (((CacheSpan)localObject).isOpenEnded()) {
    ...
    if (l1 < l4)
    {
      ...
      do
      {
        ...
        l3 = Math.max(l1, position + length);
        l2 = l3;
        l1 = l2;
      } while (l3 < l4);
    }
  ...
  {
    SimpleCacheSpan localSimpleCacheSpan = paramSimpleCacheSpan.copyWithUpdatedLastAccessTime(length);
