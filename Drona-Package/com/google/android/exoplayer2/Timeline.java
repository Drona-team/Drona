...
import com.google.android.exoplayer2.source.ClickListeners.AdPlaybackState;
import com.google.android.exoplayer2.source.ClickListeners.AdPlaybackState.AdGroup;
...
public abstract class Timeline
{
  ...
  public final Pair getPeriodPosition(Window paramWindow, Period paramPeriod, int paramInt, long paramLong)
  {
    return getPeriodPosition(paramWindow, paramPeriod, paramInt, paramLong, 0L);
  }
  
  public final Pair getPeriodPosition(Window paramWindow, Period paramPeriod, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    return Pair.create(element, Long.valueOf(paramLong1));
  }
  ...
  public static final class Period
  {
    ...
    public Period append(Object paramObject1, Object paramObject2, int paramInt, long paramLong1, long paramLong2, AdPlaybackState paramAdPlaybackState)
    {
      index = paramObject1;
      element = paramObject2;
    ...
    public Period get(Object paramObject1, Object paramObject2, int paramInt, long paramLong1, long paramLong2)
    {
      return append(paramObject1, paramObject2, paramInt, paramLong1, paramLong2, AdPlaybackState.NONE);
    }
    ...
    {
      return IpAddress.usToMs(durationUs);
    }
    ...
    {
      return IpAddress.usToMs(positionInWindowUs);
    }
  ...
  public static final class Window
  {
    ...
    {
      return IpAddress.usToMs(defaultPositionUs);
    }
    ...
    {
      return IpAddress.usToMs(positionInFirstPeriodUs);
    }
    ...
    public Window readInt(Object paramObject, long paramLong1, long paramLong2, boolean paramBoolean1, boolean paramBoolean2, long paramLong3, long paramLong4, int paramInt1, int paramInt2, long paramLong5)
    {
      head = paramObject;
