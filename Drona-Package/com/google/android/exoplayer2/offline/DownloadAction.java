...
public abstract class DownloadAction
{
  ...
  protected DownloadAction(String paramString, int paramInt, Uri paramUri, boolean paramBoolean, byte[] paramArrayOfByte)
  {
    type = paramString;
    version = paramInt;
    uuid = paramUri;
  ...
  public static Deserializer[] getDefaultDeserializers()
  {
    for (;;)
    {
      ...
      try
      {
        localObject = Class.forName("com.google.android.exoplayer2.source.dash.offline.DashDownloadAction");
        i = 2;
      }
      ...
      try
      {
        localObject = getDeserializer((Class)localObject);
        arrayOfDeserializer[1] = localObject;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        localObject = Class.forName("com.google.android.exoplayer2.source.hls.offline.HlsDownloadAction");
        j = i + 1;
      }
      ...
      {
        localObject = getDeserializer((Class)localObject);
        arrayOfDeserializer[i] = localObject;
        i = j;
      }
      ...
      try
      {
        localObject = Class.forName("com.google.android.exoplayer2.source.smoothstreaming.offline.SsDownloadAction");
        j = i + 1;
      }
  ...
  public boolean equals(Object paramObject)
  {
    if (paramObject != null)
    {
      ...
      if ((type.equals(type)) && (version == version) && (uuid.equals(uuid)) && (isRemoveAction == isRemoveAction) && (Arrays.equals(data, data))) {
        return true;
      }
    }
    return false;
