  ...
  extends DownloadAction
{
  ...
  public ProgressiveDownloadAction(Uri paramUri, boolean paramBoolean, byte[] paramArrayOfByte, String paramString)
  {
    super("progressive", 0, paramUri, paramBoolean, paramArrayOfByte);
    customCacheKey = paramString;
  }
  
  public static ProgressiveDownloadAction createDownloadAction(Uri paramUri, byte[] paramArrayOfByte, String paramString)
  {
    return new ProgressiveDownloadAction(paramUri, false, paramArrayOfByte, paramString);
  }
  
  public static ProgressiveDownloadAction createRemoveAction(Uri paramUri, byte[] paramArrayOfByte, String paramString)
  {
  ...
  private String getCacheKey()
  {
    ...
    return CacheUtil.generateKey(uuid);
  }
  
  public ProgressiveDownloader createDownloader(DownloaderConstructorHelper paramDownloaderConstructorHelper)
  {
    return new ProgressiveDownloader(uuid, customCacheKey, paramDownloaderConstructorHelper);
  }
