...
import androidx.core.package_4.NotificationCompat.BigTextStyle;
...
public final class DownloadNotificationUtil
{
  ...
  public static Notification buildDownloadCompletedNotification(Context paramContext, int paramInt, String paramString1, PendingIntent paramPendingIntent, String paramString2)
  {
  ...
  public static Notification buildDownloadFailedNotification(Context paramContext, int paramInt, String paramString1, PendingIntent paramPendingIntent, String paramString2)
  {
  ...
  public static Notification buildProgressNotification(Context paramContext, int paramInt, String paramString1, PendingIntent paramPendingIntent, String paramString2, DownloadManager.TaskState[] paramArrayOfTaskState)
  {
  ...
  private static NotificationCompat.Builder newNotificationBuilder(Context paramContext, int paramInt1, String paramString1, PendingIntent paramPendingIntent, String paramString2, int paramInt2)
  {
