...
final class ProjectionRenderer
{
  ...
  public static boolean isSupported(Projection paramProjection)
  {
    ...
    return (localMesh.getSubMeshCount() == 1) && (getSubMesh0textureId == 0) && (paramProjection.getSubMeshCount() == 1) && (getSubMesh0textureId == 0);
  }
  ...
  class MeshData
  {
    ...
    public MeshData()
    {
      vertexCount = this$1.getVertexCount();
