  ...
  extends TagPayloadReader
{
  ...
  private static HashMap readAmfEcmaArray(ParsableByteArray paramParsableByteArray)
  {
  ...
  private static HashMap readAmfObject(ParsableByteArray paramParsableByteArray)
  {
  ...
  private static ArrayList readAmfStrictArray(ParsableByteArray paramParsableByteArray)
  {
    int j = paramParsableByteArray.readUnsignedIntToInt();
