...
abstract class Atom
{
  ...
  final class ContainerAtom
    extends Atom
  {
    public final List<com.google.android.exoplayer2.extractor.mp4.Atom.ContainerAtom> containerChildren;
    public final long endPosition;
    public final List<com.google.android.exoplayer2.extractor.mp4.Atom.LeafAtom> leafChildren;
    
    public ContainerAtom(long paramLong)
    {
      super();
    ...
    public int getChildAtomOfTypeCount(int paramInt)
    {
      ...
      {
        k = i;
        if (leafChildren.get(j)).type == paramInt) {
          k = i + 1;
        }
        j += 1;
      }
      n = containerChildren.size();
      j = i;
      i = m;
      while (i < n)
      {
        k = j;
        if (containerChildren.get(i)).type == paramInt) {
          k = j + 1;
        }
        i += 1;
        j = k;
  ...
  final class LeafAtom
    extends Atom
  {
    public final ParsableByteArray data;
    
    public LeafAtom(ParsableByteArray paramParsableByteArray)
    {
      super();
