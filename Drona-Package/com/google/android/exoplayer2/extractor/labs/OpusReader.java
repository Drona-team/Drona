  ...
  extends StreamReader
{
  ...
  private void putNativeOrderLong(List paramList, int paramInt)
  {
  ...
  {
    boolean bool2 = headerRead;
    boolean bool1 = true;
    if (!bool2)
    {
      paramParsableByteArray = Arrays.copyOf(data, paramParsableByteArray.limit());
      ...
      format = Format.createAudioSampleFormat(null, "audio/opus", null, -1, -1, i & 0xFF, 48000, localArrayList, null, 0, null);
      headerRead = true;
      return true;
    }
