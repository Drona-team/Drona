  ...
  implements AnalyticsListener
{
  ...
  public EventLogger(MappingTrackSelector paramMappingTrackSelector, String paramString)
  {
  ...
  private void loge(AnalyticsListener.EventTime paramEventTime, String paramString1, String paramString2, Throwable paramThrowable)
  {
    loge(getEventString(paramEventTime, paramString1, paramString2), paramThrowable);
  }
  
  private void loge(AnalyticsListener.EventTime paramEventTime, String paramString, Throwable paramThrowable)
  {
  ...
  private void printMetadata(Metadata paramMetadata, String paramString)
  {
    ...
    while (i < paramMetadata.length())
    {
      StringBuilder localStringBuilder = new StringBuilder();
      localStringBuilder.append(paramString);
      localStringBuilder.append(paramMetadata.getFormat(i));
  ...
  {
    Log.d(LOGTAG, paramString);
  }
  
  protected void loge(String paramString, Throwable paramThrowable)
  {
    Log.e(LOGTAG, paramString, paramThrowable);
  }
  ...
  public void onTimelineChanged(AnalyticsListener.EventTime paramEventTime, int paramInt)
  {
    ...
    Object localObject = timeline;
    int j = ((Timeline)localObject).getWindowCount();
    localObject = new StringBuilder();
    ((StringBuilder)localObject).append("timelineChanged [");
    ((StringBuilder)localObject).append(getEventTimeString(paramEventTime));
    ((StringBuilder)localObject).append(", periodCount=");
    ((StringBuilder)localObject).append(k);
    ((StringBuilder)localObject).append(", windowCount=");
    ((StringBuilder)localObject).append(j);
    ((StringBuilder)localObject).append(", reason=");
    ((StringBuilder)localObject).append(getTimelineChangeReasonString(paramInt));
    ...
    while (paramInt < Math.min(k, 3))
    {
      ...
      ((Timeline)localObject).getPeriod(paramInt, period);
      localObject = new StringBuilder();
      ((StringBuilder)localObject).append("  period [");
      ((StringBuilder)localObject).append(getTimeString(period.getDurationMs()));
      ((StringBuilder)localObject).append("]");
      logd(((StringBuilder)localObject).toString());
      paramInt += 1;
    }
    localObject = paramEventTime;
    paramInt = i;
    if (k > 3)
    {
      logd("  ...");
    ...
    {
      paramEventTime = timeline;
      paramEventTime.getWindow(paramInt, window);
      paramEventTime = new StringBuilder();
      paramEventTime.append("  window [");
      paramEventTime.append(getTimeString(window.getDurationMs()));
      paramEventTime.append(", ");
      paramEventTime.append(window.isSeekable);
      paramEventTime.append(", ");
      paramEventTime.append(window.isDynamic);
      paramEventTime.append("]");
      logd(paramEventTime.toString());
      paramInt += 1;
    }
    if (j > 3) {
      logd("  ...");
  ...
  public void onTracksChanged(AnalyticsListener.EventTime paramEventTime, TrackGroupArray paramTrackGroupArray, TrackSelectionArray paramTrackSelectionArray)
  {
    ...
    while (i < m)
    {
      ...
      paramEventTime = paramTrackSelectionArray.getChapters(i);
      if (length > 0)
      {
        localObject2 = new StringBuilder();
        ...
        while (j < length)
        {
          localObject2 = ((TrackGroupArray)localObject1).context(j);
    ...
    if (length > 0)
    {
      ...
      while (i < length)
      {
        ...
        paramTrackGroupArray = paramEventTime.context(i);
        j = 0;
        while (j < length)
        {
