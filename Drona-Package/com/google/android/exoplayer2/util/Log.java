...
public final class Log
{
  ...
  private static String appendThrowableMessage(String paramString, Throwable paramThrowable)
  {
  ...
  {
    if (!logStackTraces) {
      log(paramString1, appendThrowableMessage(paramString2, paramThrowable));
    }
    if (logLevel <= 1) {
