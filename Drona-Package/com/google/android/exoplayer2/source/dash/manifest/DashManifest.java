  ...
  implements FilterableManifest<DashManifest>
{
  ...
  public DashManifest(long paramLong1, long paramLong2, long paramLong3, boolean paramBoolean, long paramLong4, long paramLong5, long paramLong6, long paramLong7, ProgramInformation paramProgramInformation, UtcTimingElement paramUtcTimingElement, Uri paramUri, List paramList)
  {
  ...
  public DashManifest(long paramLong1, long paramLong2, long paramLong3, boolean paramBoolean, long paramLong4, long paramLong5, long paramLong6, long paramLong7, UtcTimingElement paramUtcTimingElement, Uri paramUri, List paramList)
  {
  ...
  private static ArrayList copyAdaptationSets(List paramList, LinkedList paramLinkedList)
  {
    ...
    do
    {
      ...
      localArrayList1.add(new AdaptationSet(nodeId, type, localArrayList2, accessibilityDescriptors, supplementalProperties));
      localObject = localStreamKey;
    } while (periodIndex == i);
  ...
  public final DashManifest copy(List paramList)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localArrayList1.add(new Period(size, startMs - l1, localArrayList2, eventStreams));
        l2 = l1;
      }
      i += 1;
      l1 = l2;
  ...
  {
    return IpAddress.msToUs(getPeriodDurationMs(paramInt));
  }
}
