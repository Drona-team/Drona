...
public abstract class Representation
{
  ...
  private Representation(String paramString1, long paramLong, Format paramFormat, String paramString2, SegmentBase paramSegmentBase, List paramList)
  {
  ...
  public static Representation newInstance(String paramString1, long paramLong, Format paramFormat, String paramString2, SegmentBase paramSegmentBase, List paramList)
  {
    return newInstance(paramString1, paramLong, paramFormat, paramString2, paramSegmentBase, paramList, null);
  }
  
  public static Representation newInstance(String paramString1, long paramLong, Format paramFormat, String paramString2, SegmentBase paramSegmentBase, List paramList, String paramString3)
  {
    ...
    implements DashSegmentIndex
  {
    ...
    public MultiSegmentRepresentation(String paramString1, long paramLong, Format paramFormat, String paramString2, SegmentBase.MultiSegmentBase paramMultiSegmentBase, List paramList)
    {
    ...
    extends Representation
  {
    ...
    public SingleSegmentRepresentation(String paramString1, long paramLong1, Format paramFormat, String paramString2, SegmentBase.SingleSegmentBase paramSingleSegmentBase, List paramList, String paramString3, long paramLong2)
    {
      ...
      else if (paramString1 != null)
      {
        ...
        paramSingleSegmentBase.append(mimeType);
        paramSingleSegmentBase.append(".");
    ...
    public static SingleSegmentRepresentation newInstance(String paramString1, long paramLong1, Format paramFormat, String paramString2, long paramLong2, long paramLong3, long paramLong4, long paramLong5, List paramList, String paramString3, long paramLong6)
    {
