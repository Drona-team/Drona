  ...
  extends CompositeMediaSource<MediaSource.MediaPeriodId>
{
  ...
  private void onAdSourceInfoRefreshed(MediaSource paramMediaSource, int paramInt1, int paramInt2, Timeline paramTimeline)
  {
    ...
    if (paramMediaSource != null)
    {
      ...
      while (paramInt1 < paramMediaSource.size())
      {
        ...
        localDeferredMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(paramTimeline, move.windowSequenceNumber));
        paramInt1 += 1;
      }
    }
    maybeUpdateSourceInfo();
  ...
  public final class AdLoadException
    extends IOException
  {
    ...
    private AdLoadException(Exception paramException)
    {
      super();
      type = this$1;
    }
  ...
  public abstract interface MediaSourceFactory
  {
