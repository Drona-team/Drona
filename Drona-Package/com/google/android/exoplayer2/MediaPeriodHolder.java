...
{
  private static final String PAGE_KEY = "MediaPeriodHolder";
  ...
  private void disableTrackSelectionsInResult(TrackSelectorResult paramTrackSelectorResult)
  {
    ...
    while (i < length)
    {
      ...
      TrackSelection localTrackSelection = selections.getChapters(i);
  ...
  public long applyTrackSelection(long paramLong, boolean paramBoolean, boolean[] paramArrayOfBoolean)
  {
    ...
    while (i < sampleStreams.length)
    {
      ...
      {
        if (((TrackSelectionArray)localObject).getChapters(i) == null) {
          paramBoolean = true;
        } else {
          paramBoolean = false;
        }
  ...
  public void release()
  {
    ...
    try
    {
      long l = info.anchor.endPositionUs;
      if (l != Long.MIN_VALUE)
      {
