  ...
  implements Connectivity
{
  ...
  public ConnectivityCompat(Context paramContext, Function1 paramFunction1)
  {
    ...
    throw ((Throwable)new TypeCastException("null cannot be cast to non-null type android.net.ConnectivityManager"));
  }
