  ...
  implements FileCacheFactory
{
  ...
  public FileCache getImageUrl(DiskCacheConfig paramDiskCacheConfig)
  {
    return buildDiskStorageCache(paramDiskCacheConfig, mDiskStorageFactory.createIndex(paramDiskCacheConfig));
  }
}
