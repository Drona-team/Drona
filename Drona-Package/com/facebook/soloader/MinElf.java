...
public final class MinElf
{
    ...
    throws IOException
  {
    ...
    if (getu32(paramFileChannel, localByteBuffer, 0L) == 1179403647L)
    {
      ...
      long l3 = l2;
      long l5;
      for (long l1 = 0L; l1 < l4; l1 += 1L)
      {
        if (i != 0) {
          l5 = getu32(paramFileChannel, localByteBuffer, l3 + 0L);
        } else {
          l5 = getu32(paramFileChannel, localByteBuffer, l3 + 0L);
        }
        if (l5 == 2L)
        {
          if (i != 0)
          {
            l1 = getu32(paramFileChannel, localByteBuffer, l3 + 4L);
            break label357;
          }
          l1 = get64(paramFileChannel, localByteBuffer, l3 + 8L);
          break label357;
        }
        l3 += j;
      }
      ...
      if (l1 != 0L)
      {
        ...
        for (int m = 0;; m = k)
        {
          ...
          else
          {
            ...
            {
              if (i != 0) {
                l3 = getu32(paramFileChannel, localByteBuffer, l5 + 4L);
              } else {
                l3 = get64(paramFileChannel, localByteBuffer, l5 + 8L);
              }
              k = m;
            }
          }
