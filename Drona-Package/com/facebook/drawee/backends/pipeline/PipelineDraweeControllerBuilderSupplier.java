  ...
  implements Supplier<PipelineDraweeControllerBuilder>
{
  ...
  public PipelineDraweeControllerBuilderSupplier(Context paramContext, DraweeConfig paramDraweeConfig)
  {
    this(paramContext, ImagePipelineFactory.getInstance(), paramDraweeConfig);
  }
  
  public PipelineDraweeControllerBuilderSupplier(Context paramContext, ImagePipelineFactory paramImagePipelineFactory, DraweeConfig paramDraweeConfig)
  {
    this(paramContext, paramImagePipelineFactory, null, paramDraweeConfig);
  }
  
  public PipelineDraweeControllerBuilderSupplier(Context paramContext, ImagePipelineFactory paramImagePipelineFactory, Set paramSet, DraweeConfig paramDraweeConfig)
  {
  ...
  public PipelineDraweeControllerBuilder getFolder()
  {
