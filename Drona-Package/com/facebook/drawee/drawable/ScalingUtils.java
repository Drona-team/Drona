...
public class ScalingUtils
{
    ...
    implements ScalingUtils.ScaleType, ScalingUtils.StatefulScaleType
  {
    ...
    public InterpolatingScaleType(ScalingUtils.ScaleType paramScaleType1, ScalingUtils.ScaleType paramScaleType2, Rect paramRect1, Rect paramRect2)
    {
      this(paramScaleType1, paramScaleType2, paramRect1, paramRect2, null, null);
    }
    
    public InterpolatingScaleType(ScalingUtils.ScaleType paramScaleType1, ScalingUtils.ScaleType paramScaleType2, Rect paramRect1, Rect paramRect2, PointF paramPointF1, PointF paramPointF2)
    {
    ...
    extends ScalingUtils.AbstractScaleType
  {
    ...
    public void getTransformImpl(Matrix paramMatrix, Rect paramRect, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
    {
      ...
      {
        paramFloat1 = left + (paramRect.width() - paramInt1 * paramFloat4) * 0.5F;
        paramFloat2 = top;
      ...
      else
      {
        paramFloat1 = left;
        paramFloat2 = top;
        paramFloat2 = (paramRect.height() - paramInt2 * paramFloat3) * 0.5F + paramFloat2;
      }
    ...
    extends ScalingUtils.AbstractScaleType
  {
    ...
    public void getTransformImpl(Matrix paramMatrix, Rect paramRect, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
    {
      if (paramFloat4 > paramFloat3)
      {
        ...
        paramFloat1 = left + Math.max(Math.min(paramFloat2 * 0.5F - paramFloat1 * paramFloat3, 0.0F), paramRect.width() - paramFloat3);
        paramFloat2 = top;
        paramFloat3 = paramFloat4;
      }
      else
      {
        ...
        float f2 = top;
        paramFloat2 = Math.max(Math.min(paramFloat4 * 0.5F - paramFloat2 * f1, 0.0F), paramRect.height() - f1) + f2;
      }
      paramMatrix.setScale(paramFloat3, paramFloat3);
      paramMatrix.postTranslate((int)(paramFloat1 + 0.5F), (int)(paramFloat2 + 0.5F));
    }
