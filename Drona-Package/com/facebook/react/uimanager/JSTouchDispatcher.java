...
public class JSTouchDispatcher
{
  ...
  public void handleTouchEvent(MotionEvent paramMotionEvent, EventDispatcher paramEventDispatcher)
  {
    ...
    if (i == 1)
    {
      ...
      paramEventDispatcher.dispatchEvent(TouchEvent.obtain(mTargetTag, TouchEventType.PENCIL, paramMotionEvent, mGestureStartTime, mTargetCoordinates[0], mTargetCoordinates[1], mTouchEventCoalescingKeyHelper));
      mTargetTag = -1;
