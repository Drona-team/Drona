  ...
  public static boolean isLayoutOnly(ReadableMap paramReadableMap, String paramString)
  {
    ...
    if ("pointerEvents".equals(paramString))
    {
      ...
      if (!"auto".equals(paramReadableMap)) {
        return "box-none".equals(paramReadableMap);
      }
    }
    else
    {
      ...
      case 11: 
        if (!paramReadableMap.isNull("overflow")) {
          return "visible".equals(paramReadableMap.getString("overflow"));
        }
        break;
      case 10: 
        if (!paramReadableMap.isNull("borderBottomWidth")) {
          return paramReadableMap.getDouble("borderBottomWidth") == 0.0D;
        }
        break;
      case 9: 
        if (!paramReadableMap.isNull("borderRightWidth")) {
          return paramReadableMap.getDouble("borderRightWidth") == 0.0D;
        }
        break;
      case 8: 
        if (!paramReadableMap.isNull("borderTopWidth")) {
          return paramReadableMap.getDouble("borderTopWidth") == 0.0D;
        }
        break;
      case 7: 
        if (!paramReadableMap.isNull("borderLeftWidth")) {
          return paramReadableMap.getDouble("borderLeftWidth") == 0.0D;
        }
        break;
      case 6: 
        if (!paramReadableMap.isNull("borderWidth")) {
          return paramReadableMap.getDouble("borderWidth") == 0.0D;
        }
        break;
      case 5: 
      ...
      case 1: 
        ...
        if (paramReadableMap.hasKey("borderWidth"))
        {
          if ((!paramReadableMap.isNull("borderWidth")) && (paramReadableMap.getDouble("borderWidth") != 0.0D)) {
            return false;
          }
        }
        else {
      ...
      case 0: 
        if (!paramReadableMap.isNull("opacity")) {
          return paramReadableMap.getDouble("opacity") == 1.0D;
        }
        break;
      }
    }
