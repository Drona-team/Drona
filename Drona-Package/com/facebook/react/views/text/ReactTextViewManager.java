  ...
  implements IViewManagerWithChildren
{
  ...
  {
    return MapBuilder.get("topTextLayout", MapBuilder.get("registrationName", "onTextLayout"), "topInlineViewLayout", MapBuilder.get("registrationName", "onInlineViewLayout"));
  }
