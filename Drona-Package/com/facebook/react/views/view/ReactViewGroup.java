  ...
  implements ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactHitSlopView, ReactZIndexedViewGroup
{
    ...
    if (mOverflow != null)
    {
      ...
      case 1: 
        ...
        if (mReactBackgroundDrawable != null)
        {
          ...
          f8 = mReactBackgroundDrawable.getFullBorderRadius();
          f5 = mReactBackgroundDrawable.getBorderRadiusOrDefaultTo(f8, ReactViewBackgroundDrawable.BorderRadiusLocation.TOP_LEFT);
          float f9 = f5;
          float f14 = mReactBackgroundDrawable.getBorderRadiusOrDefaultTo(f8, ReactViewBackgroundDrawable.BorderRadiusLocation.TOP_RIGHT);
          f6 = f14;
          float f13 = mReactBackgroundDrawable.getBorderRadiusOrDefaultTo(f8, ReactViewBackgroundDrawable.BorderRadiusLocation.BOTTOM_LEFT);
          f7 = f13;
          f8 = mReactBackgroundDrawable.getBorderRadiusOrDefaultTo(f8, ReactViewBackgroundDrawable.BorderRadiusLocation.BOTTOM_RIGHT);
          float f11 = f7;
          float f10 = f8;
          float f12 = f6;
          Object localObject2;
          if (Build.VERSION.SDK_INT >= 17)
          {
            ...
            f12 = mReactBackgroundDrawable.getBorderRadius(ReactViewBackgroundDrawable.BorderRadiusLocation.TOP_START);
            float f17 = mReactBackgroundDrawable.getBorderRadius(ReactViewBackgroundDrawable.BorderRadiusLocation.TOP_END);
            f11 = f17;
            f9 = mReactBackgroundDrawable.getBorderRadius(ReactViewBackgroundDrawable.BorderRadiusLocation.BOTTOM_START);
            float f16 = f9;
            f10 = mReactBackgroundDrawable.getBorderRadius(ReactViewBackgroundDrawable.BorderRadiusLocation.BOTTOM_END);
            float f15 = f10;
          ...
          else
          {
            ...
            f5 = Math.max(f9 - left, 0.0F);
            f6 = Math.max(f9 - top, 0.0F);
            i = 1;
            f7 = Math.max(f12 - right, 0.0F);
            f8 = Math.max(f12 - top, 0.0F);
            f9 = Math.max(f10 - right, 0.0F);
            f10 = Math.max(f10 - bottom, 0.0F);
            f12 = Math.max(f11 - left, 0.0F);
            f11 = Math.max(f11 - bottom, 0.0F);
            localObject1 = Path.Direction.CW;
            ((Path)localObject2).addRoundRect(localRectF, new float[] { f5, f6, f7, f8, f9, f10, f12, f11 }, (Path.Direction)localObject1);
  ...
  {
    throw new Error("Unresolved compilation error: Method <com.facebook.react.views.view.ReactViewGroup: void setForeground(android.graphics.drawable.Drawable)> does not exist!");
  }
