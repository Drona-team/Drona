    ...
    for (;;)
    {
      try
      {
        ...
        if (localHeadlessJsTaskConfig != null)
        {
          ...
          ((StringBuilder)localObject).append("Tried to retrieve non-existent task config with id ");
          ((StringBuilder)localObject).append(paramInt);
          ((StringBuilder)localObject).append(".");
          Assertions.assertCondition(bool, ((StringBuilder)localObject).toString());
          localObject = localHeadlessJsTaskConfig.getRetryPolicy();
          bool = ((HeadlessJsTaskRetryPolicy)localObject).canRetry();
          if (!bool) {
            return false;
          }
          removeTimeout(paramInt);
          ...
          }, ((HeadlessJsTaskRetryPolicy)localObject).getDelay());
          return true;
        }
      }
      catch (Throwable localThrowable)
