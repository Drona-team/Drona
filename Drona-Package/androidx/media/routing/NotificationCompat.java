...
import androidx.core.package_4.NotificationBuilderWithBuilderAccessor;
import androidx.core.package_4.NotificationCompat.Action;
...
public class NotificationCompat
{
    ...
    extends NotificationCompat.MediaStyle
  {
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      ...
      {
        paramNotificationBuilderWithBuilderAccessor.getBuilder().setStyle(fillInMediaStyle((Notification.MediaStyle)new Notification.DecoratedMediaCustomViewStyle()));
        return;
      }
    ...
    extends NotificationCompat.Style
  {
    ...
    {
      paramNotification = androidx.core.package_4.NotificationCompat.getExtras(paramNotification);
