  ...
  implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3
{
  ...
  public RecyclerView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    mClipToPadding = ((TypedArray)localObject).getBoolean(R.styleable.RecyclerView_android_clipToPadding, true);
  ...
  private boolean dispatchToOnItemTouchListeners(MotionEvent paramMotionEvent)
  {
    ...
    mInterceptingOnItemTouchListener.onTouchEvent(this, paramMotionEvent);
  ...
  public View focusSearch(View paramView, int paramInt)
  {
    ...
    int i;
    if ((mAdapter != null) && (mLayout != null) && (!isComputingLayout()) && (!mLayoutSuppressed)) {
      i = 1;
    } else {
      i = 0;
    }
    ...
    if (!bool1)
    {
      ...
      case 2: 
        ...
        if (mScrollState != 1)
        {
          ...
          {
            if (m > 0) {
              i = Math.max(0, m - mTouchSlop);
            } else {
              i = Math.min(0, m + mTouchSlop);
            }
            k = i;
            if (i != 0)
            {
          ...
          {
            if (n > 0) {
              j = Math.max(0, n - mTouchSlop);
            } else {
              j = Math.min(0, n + mTouchSlop);
            }
            m = j;
            i1 = i;
            if (j != 0)
        ...
        int k = m;
        j = i;
        if (dispatchNestedPreScroll(n, i1, mReusableIntPair, mScrollOffset, 0))
        {
          k = m - mReusableIntPair[0];
          j = i - mReusableIntPair[1];
          int[] arrayOfInt = mNestedOffsets;
          arrayOfInt[0] += mScrollOffset[0];
          arrayOfInt = mNestedOffsets;
          arrayOfInt[1] += mScrollOffset[1];
          getParent().requestDisallowInterceptTouchEvent(true);
        }
        ...
        if (scrollByInternal(i, m, paramMotionEvent)) {
          getParent().requestDisallowInterceptTouchEvent(true);
        }
        n = i2;
        if (mGapWorker == null) {
        ...
        {
          mGapWorker.postFromTraversal(this, k, j);
          n = i2;
        }
        break;
      case 1: 
  ...
  {
    throw new Error("Unresolved compilation error: Method <androidx.recyclerview.widget.RecyclerView: void saveAttributeDataForStyleable(android.content.Context,int[],android.util.AttributeSet,android.content.res.TypedArray,int,int)> does not exist!");
  }
  ...
  boolean scrollByInternal(int paramInt1, int paramInt2, MotionEvent paramMotionEvent)
  {
    ...
    if (mAdapter != null)
    {
      mReusableIntPair[0] = 0;
      mReusableIntPair[1] = 0;
      scrollStep(paramInt1, paramInt2, mReusableIntPair);
      i = mReusableIntPair[0];
      j = mReusableIntPair[1];
      m = paramInt1 - i;
      k = paramInt2 - j;
    }
    else
    ...
    mReusableIntPair[0] = 0;
    mReusableIntPair[1] = 0;
    dispatchNestedScroll(i, j, m, k, mScrollOffset, 0, mReusableIntPair);
    int i1 = mReusableIntPair[0];
    int i2 = mReusableIntPair[1];
    int n;
    if ((mReusableIntPair[0] == 0) && (mReusableIntPair[1] == 0)) {
      n = 0;
    } else {
      n = 1;
    }
    ...
    if (getOverScrollMode() != 2)
    {
      if ((paramMotionEvent != null) && (!MotionEventCompat.isFromSource(paramMotionEvent, 8194))) {
        pullGlows(paramMotionEvent.getX(), m - i1, paramMotionEvent.getY(), k - i2);
      }
  ...
  void smoothScrollBy(int paramInt1, int paramInt2, Interpolator paramInterpolator, int paramInt3, boolean paramBoolean)
  {
    ...
    boolean bool = mLayout.canScrollHorizontally();
    int j = 0;
    int i = paramInt1;
    if (!bool) {
      i = 0;
    ...
    if ((i != 0) || (paramInt2 != 0))
    {
      ...
      if (paramInt1 != 0)
      {
        ...
        mViewFlinger.smoothScrollBy(i, paramInt2, paramInt3, paramInterpolator);
        return;
      }
  ...
  public static abstract class LayoutManager
  {
    ...
    public boolean performAccessibilityAction(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt, Bundle paramBundle)
    {
      ...
      mRecyclerView.smoothScrollBy(i, paramInt, null, Integer.MIN_VALUE, true);
      return true;
    }
  ...
  public final class Recycler
  {
    ...
    private void attachAccessibilityDelegateOnBind(RecyclerView.ViewHolder paramViewHolder)
    {
      if (isAccessibilityEnabled())
      {
        ...
        AccessibilityDelegateCompat localAccessibilityDelegateCompat = mAccessibilityDelegate.getItemDelegate();
    ...
    RecyclerView.ViewHolder getScrapOrCachedViewForId(long paramLong, int paramInt, boolean paramBoolean)
    {
      ...
      while (i >= 0)
      {
        ...
        localObject2 = localObject1;
        localObject3 = (RecyclerView.ViewHolder)((ArrayList)localObject3).get(i);
        if ((((RecyclerView.ViewHolder)localObject3).getItemId() == paramLong) && (!((RecyclerView.ViewHolder)localObject3).isAttachedToTransitionOverlay()))
        {
          if (paramInt == ((RecyclerView.ViewHolder)localObject3).getItemViewType())
          {
            localObject1 = localObject3;
    ...
    implements Runnable
  {
    ...
    OverScroller mOverScroller = new OverScroller(getContext(), RecyclerView.sQuinticInterpolator);
    ...
    public void fling(int paramInt1, int paramInt2)
    {
      ...
      mLastFlingY = 0;
      mLastFlingX = 0;
      if (mInterpolator != RecyclerView.sQuinticInterpolator)
      {
        mInterpolator = RecyclerView.sQuinticInterpolator;
        mOverScroller = new OverScroller(getContext(), RecyclerView.sQuinticInterpolator);
      }
    ...
    public void run()
    {
      ...
      consumePendingUpdateOperations();
      Object localObject = mOverScroller;
      if (((OverScroller)localObject).computeScrollOffset())
      {
        ...
        i = k;
        j = m;
        if (dispatchNestedPreScroll(m, k, mReusableIntPair, null, 1))
        {
          j = m - mReusableIntPair[0];
          i = k - mReusableIntPair[1];
        }
        if (getOverScrollMode() != 2) {
        ...
        if (mAdapter != null)
        {
          mReusableIntPair[0] = 0;
          mReusableIntPair[1] = 0;
          scrollStep(j, i, mReusableIntPair);
          n = mReusableIntPair[0];
          i1 = mReusableIntPair[1];
          int i2 = j - n;
          int i3 = i - i1;
          localSmoothScroller = mLayout.mSmoothScroller;
          j = n;
          i = i1;
          k = i3;
          m = i2;
          if (localSmoothScroller != null)
          {
            ...
            if (!localSmoothScroller.isPendingInitialRun())
            {
              ...
              if (localSmoothScroller.isRunning())
              {
                ...
                else if (localSmoothScroller.getTargetPosition() >= i)
                {
                  localSmoothScroller.setTargetPosition(i - 1);
                  localSmoothScroller.onAnimation(n, i1);
                  j = n;
                  i = i1;
                  k = i3;
                  m = i2;
        ...
        mReusableIntPair[0] = 0;
        mReusableIntPair[1] = 0;
        dispatchNestedScroll(j, i, m, k, null, 1, mReusableIntPair);
        int i1 = m - mReusableIntPair[0];
        int n = k - mReusableIntPair[1];
        if ((j != 0) || (i != 0)) {
        ...
        else
        {
          postOnAnimation();
          if (mGapWorker != null) {
            mGapWorker.postFromTraversal(RecyclerView.this, j, i);
          }
        }
      }
      localObject = mLayout.mSmoothScroller;
