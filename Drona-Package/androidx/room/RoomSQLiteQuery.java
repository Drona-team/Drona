  ...
  implements SupportSQLiteQuery, SupportSQLiteProgram
{
  ...
  {
    Object localObject1 = sQueryPool;
    try
    {
      ...
      localObject1 = new RoomSQLiteQuery(paramInt);
      ((RoomSQLiteQuery)localObject1).init(paramString, paramInt);
      return localObject1;
    }
  ...
  public void release()
  {
    TreeMap localTreeMap = sQueryPool;
    try
    {
