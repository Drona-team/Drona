...
public final class FingerprintManagerCompat
{
  ...
  public void authenticate(CryptoObject paramCryptoObject, int paramInt, androidx.core.opml.CancellationSignal paramCancellationSignal, AuthenticationCallback paramAuthenticationCallback, Handler paramHandler)
  {
    if (Build.VERSION.SDK_INT >= 23)
    {
