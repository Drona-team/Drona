...
public final class ContentResolverCompat
{
  ...
  public static Cursor query(ContentResolver paramContentResolver, Uri paramUri, String[] paramArrayOfString1, String paramString1, String[] paramArrayOfString2, String paramString2, androidx.core.opml.CancellationSignal paramCancellationSignal)
  {
    if (Build.VERSION.SDK_INT >= 16)
    {
      ...
      if ((paramContentResolver instanceof android.os.OperationCanceledException)) {
        throw new androidx.core.opml.OperationCanceledException();
      }
