    ...
    extends NotificationCompat.Style
  {
    ...
    public void addCompatExtras(Bundle paramBundle)
    {
      ...
      if (mIsGroupConversation != null) {
        paramBundle.putBoolean("android.isGroupConversation", mIsGroupConversation.booleanValue());
      }
    }
    ...
    public boolean isGroupConversation()
    {
      ...
      else if (mIsGroupConversation != null) {
        return mIsGroupConversation.booleanValue();
      }
      return false;
    }
    ...
    public final class Message
    {
      ...
      private Bundle toBundle()
      {
        ...
        if (mPerson != null)
        {
          localBundle.putCharSequence("sender", mPerson.getName());
          if (Build.VERSION.SDK_INT >= 28) {
