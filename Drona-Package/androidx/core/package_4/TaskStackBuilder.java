  ...
  public PendingIntent getPendingIntent(int paramInt1, int paramInt2, Bundle paramBundle)
  {
    if (!mIntents.isEmpty())
    {
      ...
      if (Build.VERSION.SDK_INT >= 16) {
        return PendingIntent.getActivities(mSourceContext, paramInt1, arrayOfIntent, paramInt2, paramBundle);
      }
      return PendingIntent.getActivities(mSourceContext, paramInt1, arrayOfIntent, paramInt2);
    }
