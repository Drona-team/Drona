  ...
  implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView
{
  ...
  public void computeScroll()
  {
    ...
    int k = 0;
    arrayOfInt[1] = 0;
    dispatchNestedPreScroll(0, i, mScrollConsumed, null, 1);
    ...
    if (j != 0)
    {
      ...
      j -= i;
      mScrollConsumed[1] = 0;
      dispatchNestedScroll(0, i, 0, j, mScrollOffset, 1, mScrollConsumed);
  ...
  protected int computeScrollDeltaToGetChildRectOnScreen(Rect paramRect)
  {
    ...
    if ((bottom > j) && (top > i))
    {
      ...
      return Math.min(i, localView.getBottom() + bottomMargin - k);
    }
    if ((top < i) && (bottom < j))
    {
      if (paramRect.height() > m) {
  ...
  public boolean fullScroll(int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      if (i > 0)
      {
        ...
        FrameLayout.LayoutParams localLayoutParams = (FrameLayout.LayoutParams)localView.getLayoutParams();
        mTempRect.bottom = (localView.getBottom() + bottomMargin + getPaddingBottom());
    ...
    case 2: 
      ...
      else
      {
        ...
        if (mIsBeingDragged)
        {
          ...
          int i1 = getScrollY() - n;
          mScrollConsumed[1] = 0;
          dispatchNestedScroll(0, i1, 0, i - i1, mScrollOffset, 0, mScrollConsumed);
  ...
  public boolean pageScroll(int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      if (i > 0)
      {
        View localView = getChildAt(i - 1);
        FrameLayout.LayoutParams localLayoutParams = (FrameLayout.LayoutParams)localView.getLayoutParams();
        i = localView.getBottom() + bottomMargin + getPaddingBottom();
