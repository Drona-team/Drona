...
public class TypefaceCompatUtil
{
  ...
  public static ByteBuffer mmap(Context paramContext, android.os.CancellationSignal paramCancellationSignal, android.net.Uri paramUri)
  {
    ...
    //   7: ldc -114
    //   9: aload_1
    //   10: invokevirtual 148	android/content/ContentResolver:openFileDescriptor	(Landroid/net/Uri;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/os/ParcelFileDescriptor;
    //   13: astore_0
    //   14: aload_0
    //   15: ifnonnull +13 -> 28
    //   18: aload_0
    //   19: ifnull +128 -> 147
    //   22: aload_0
    //   23: invokevirtual 151	android/os/ParcelFileDescriptor:close	()V
    //   26: aconst_null
    //   27: areturn
    //   28: new 153	java/io/FileInputStream
    //   31: dup
    //   32: aload_0
    //   33: invokevirtual 157	android/os/ParcelFileDescriptor:getFileDescriptor	()Ljava/io/FileDescriptor;
    //   36: invokespecial 160	java/io/FileInputStream:<init>	(Ljava/io/FileDescriptor;)V
    //   39: astore_1
    //   40: aload_1
    //   41: invokevirtual 164	java/io/FileInputStream:getChannel	()Ljava/nio/channels/FileChannel;
    //   44: astore_2
    //   45: aload_2
    //   46: invokevirtual 170	java/nio/channels/FileChannel:size	()J
    //   49: lstore_3
    //   50: aload_2
    //   51: getstatic 176	java/nio/channels/FileChannel$MapMode:READ_ONLY	Ljava/nio/channels/FileChannel$MapMode;
    //   54: lconst_0
    //   55: lload_3
    //   56: invokevirtual 180	java/nio/channels/FileChannel:map	(Ljava/nio/channels/FileChannel$MapMode;JJ)Ljava/nio/MappedByteBuffer;
    //   59: astore_2
    //   60: aload_1
    //   61: invokevirtual 181	java/io/FileInputStream:close	()V
    //   64: aload_0
    //   65: ifnull +84 -> 149
    //   68: aload_0
    //   69: invokevirtual 151	android/os/ParcelFileDescriptor:close	()V
    //   72: aload_2
    //   73: areturn
    //   74: astore_2
    //   75: aload_2
    ...
    //   80: ifnull +19 -> 99
    //   83: aload_1
    //   84: invokevirtual 181	java/io/FileInputStream:close	()V
    //   87: goto +16 -> 103
    //   90: astore_1
    //   91: aload_2
    //   92: aload_1
    //   93: invokevirtual 185	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   96: goto +7 -> 103
    //   99: aload_1
    //   100: invokevirtual 181	java/io/FileInputStream:close	()V
    //   103: aload 5
    //   105: athrow
    //   106: astore_1
    //   107: aload_1
    ...
    //   115: ifnull +19 -> 134
    //   118: aload_0
    //   119: invokevirtual 151	android/os/ParcelFileDescriptor:close	()V
    //   122: goto +16 -> 138
    //   125: astore_0
    //   126: aload_1
    //   127: aload_0
    //   128: invokevirtual 185	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   131: goto +7 -> 138
    //   134: aload_0
    //   135: invokevirtual 151	android/os/ParcelFileDescriptor:close	()V
    //   138: aload_2
    //   139: athrow
    //   140: astore_0
    //   141: aconst_null
