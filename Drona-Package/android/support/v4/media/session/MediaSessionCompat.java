    ...
    public boolean onMediaButtonEvent(Intent paramIntent)
    {
      ...
      if (localMediaSessionImpl != null)
      {
        ...
        if (paramIntent != null)
        {
          ...
          mCallbackHandler.sendMessageDelayed(mCallbackHandler.obtainMessage(1, localRemoteUserInfo), ViewConfiguration.getDoubleTapTimeout());
          return true;
        }
      }
      return false;
    ...
    implements Parcelable
  {
    ...
    public Bundle toBundle()
    {
      ...
      if (mExtraBinder != null) {
        BundleCompat.putBinder(localBundle, "android.support.v4.media.session.EXTRA_BINDER", mExtraBinder.asBinder());
      }
      if (mSessionToken2Bundle != null) {
        localBundle.putBundle("android.support.v4.media.session.SESSION_TOKEN2_BUNDLE", mSessionToken2Bundle);
      }
      return localBundle;
    }
