    ...
    extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      if (mCallbacksMessengerRef != null)
      {
        ...
        MediaSessionCompat.ensureClassLoader((Bundle)localObject1);
      ...
      try
      {
        localBundle = ((Bundle)localObject1).getBundle("data_options");
        MediaSessionCompat.ensureClassLoader(localBundle);
        localObject2 = ((Bundle)localObject1).getBundle("data_notify_children_changed_options");
        MediaSessionCompat.ensureClassLoader((Bundle)localObject2);
        localMediaBrowserServiceCallbackImpl.onLoadChildren(localMessenger, ((BaseBundle)localObject1).getString("data_media_item_id"), ((Bundle)localObject1).getParcelableArrayList("data_media_item_list"), localBundle, (Bundle)localObject2);
        return;
      }
      ...
      return;
      localBundle = ((Bundle)localObject1).getBundle("data_root_hints");
      MediaSessionCompat.ensureClassLoader(localBundle);
      localObject2 = ((BaseBundle)localObject1).getString("data_media_item_id");
      Object localObject1 = ((Bundle)localObject1).getParcelable("data_media_session_token");
      localObject1 = (MediaSessionCompat.Token)localObject1;
      localMediaBrowserServiceCallbackImpl.onServiceConnected(localMessenger, (String)localObject2, (MediaSessionCompat.Token)localObject1, localBundle);
      return;
